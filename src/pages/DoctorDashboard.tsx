    ...
    const interval = setInterval(() => {
      ...
      if (Math.random() < 0.05) { // 5% chance
        ...
        setEmergencyPatient({
          ...patient,
          emergency: {
            type: 'High Blood Pressure Alert',
            severity: 'high' as const,
            description: 'Blood pressure reading 180/110 mmHg detected via wearable device',
            vitals: {
              heartRate: 95,
    ...
    <div className="p-4 md:p-6 space-y-6 max-w-7xl mx-auto">
      ...
      >
        ...
        <div className="flex items-center gap-2">
          <Button 
            variant="outline" 
            className="gap-2"
            onClick={() => toast.success('Telemedicine portal opening...')}
          >
          ...
          <Button 
            className="gap-2"
            onClick={() => toast.success('Schedule view opening...')}
          >
      ...
      <Tabs defaultValue="patients" className="space-y-6">
        ...
        <TabsContent value="analytics" className="space-y-6">
          ...
          <MLPredictionWidget userRole="doctor" />
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex gap-2">
                        <Button 
                          variant="outline" 
                          size="sm"
                          onClick={() => toast.success(`Starting video call with ${appointment.patientName}...`)}
                        >
                        ...
                        <Button 
                          size="sm"
                          onClick={() => toast.success(`Appointment started with ${appointment.patientName}`)}
                        >
                          Start
                        </Button>
                      </div>
      ...
      <FileUploadModal
        ...
        description="Upload lab results, prescriptions, or other medical documents"

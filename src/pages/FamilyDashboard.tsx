...
export default function FamilyDashboard() {
  ...
  // Simulate emergency alerts for family
  useEffect(() => {
    const interval = setInterval(() => {
      // Random chance of emergency alert for demo
      if (Math.random() < 0.03) { // 3% chance
        setEmergencyPatient({
          ...
          emergency: {
            ...
            description: 'Father missed evening Metformin dose - automated reminder failed',
            vitals: {
              heartRate: 78,
  ...
  return (
    <div className="p-4 md:p-6 space-y-6 max-w-7xl mx-auto">
      ...
      >
        ...
        <div className="flex items-center gap-2">
          <Button 
            ...
            onClick={() => {
              setEmergencyPatient({
                ...patientData,
                emergency: {
                  type: 'Manual Emergency Call',
                  severity: 'high' as const,
                  description: 'Family member initiated emergency contact',
          ...
          <Button 
            variant="outline" 
            size="icon"
            onClick={() => toast.success('Notifications center opened')}
          >
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
                  ...
                  <Alert className={`${getSeverityColor(alert.severity)} ${!alert.read ? 'border-l-4' : ''}`}>
                    <div className="flex items-start justify-between">
                      ...
                      <Button 
                        variant="ghost" 
                        size="sm"
                        onClick={() => toast.success('Alert marked as read')}
                      >
                        Mark as read
                      </Button>
                    </div>
              ...
              <Button 
                variant="outline" 
                className="w-full"
                onClick={() => toast.success('All alerts view opened')}
              >
                View All Alerts
              </Button>
            </CardContent>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <Button 
                className="w-full" 
                variant="outline"
                onClick={() => toast.success('Detailed vitals history opened')}
              >
      ...
      >
        <MLPredictionWidget userRole="family" patientId={patientData.id} />
      </motion.div>
          ...
          <CardContent>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <Button 
                ...
                onClick={() => toast.success(`Calling ${patientData.name}...`)}
              >
              ...
              <Button 
                variant="outline" 
                className="h-auto py-4 flex flex-col items-center gap-2"
                onClick={() => toast.success('Medication reminder sent to patient')}
              >
              ...
              <Button 
                ...
                onClick={() => {
                  setEmergencyPatient({
                    ...patientData,
                    emergency: {
                      type: 'Family Emergency Request',
                      severity: 'high' as const,
                      description: 'Family member requesting immediate assistance',
                      vitals: patientData.vitals,
                      timestamp: new Date()
                    }
                  });
      ...
      <AppointmentBookingModal
        ...
        onBookingComplete={(appointment) => {
          ...
          toast.success(`Appointment booked for ${appointment.date} at ${appointment.time}`);
        }}
      />
    </div>
  );
